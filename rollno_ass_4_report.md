...
**Student Roll No:** [Your Roll Number]  
**Course:** MLOps  
**Date:** March 2026
...
|---------------|------------|
| Learning Rate | *[To be filled after running]* |
| Batch Size | *[To be filled after running]* |
| Num Heads | *[To be filled after running]* |
| d_ff | *[To be filled after running]* |
| Dropout | *[To be filled after running]* |
...
|--------|----------------------|-------------------------------|
| **Epochs** | 100 | ≤50 |
| **Training Time** | ~53 min | *[To be filled]* |
| **Final Loss** | 0.0974 | *[To be filled]* |
| **BLEU Score** | 52.47% | *[To be filled]* |
